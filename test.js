...
const addon1 = new Addon('addon 1');
...
addon1.RP().Item().addItem(helmet, { type: 'helmet' }).addItem(chestplate, { type: 'chestplate' }).addItem(leggings, { type: 'leggings' }).addItem(boots, { type: 'boots' });
